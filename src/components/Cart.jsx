...
const Cart = ({
  ...
  const allSizesChosen = items.every(
  ...
  const handleSendOrder = (e) => {
    ...
    if (!allSizesChosen) {
      setStatusError(true);
      setStatusMessage(
        "Please choose a size for every item before sending your order."
      );
      return;
    }
    if (
      ...
      setStatusError(true);
      setStatusMessage(
        "Please enter a valid name and email address before sending your order."
      );
      return;
    }
  ...
  const totalCost = items.length * 450;
    ...
    <div className={`cart-overlay ${isOpen ? "open" : ""}`} onClick={onClose}>
      ...
      >
        ...
        <div className="cart-footer-text">
          <p>
            All T-shirts are made from organic cotton, available in unisex
            sizes. Since we're a one-person, underground print-on-demand
            operation, expect about a month for delivery.
          </p>
          <p>Each T-shirt costs 450 SEK plus around 60 SEK for shipping.</p>
          ...
          <>
            ...
            <div className="cart-total">
              <p>
                ...
                <span className="cart-total__shipping-text">plus shipping</span>
                .
              </p>
            </div>
          </>
        ...
        <div className="cart-send-wrapper">
          {readyToSend && (
            <button className="cart-send-button" onClick={handleSendOrder}>
              Send Order
            </button>
          )}
        </div>
